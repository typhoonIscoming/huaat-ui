...
/* harmony default export */ var calendar_src_mainvue_type_script_lang_js_ = ({
  ...
  data: function data() {
    return {
      ...
      today: '',
      myDate: new Date(),
      dayList: [] // selectRangeIsDone: true, // 选择范围的操作是否完成
      // rangeStartValue: '',
      // rangeEndValue: '',
      // tempHoverEndValue: '',
  ...
  methods: {
    ...
    handleSelected: function handleSelected(item, type) {
      ...
      if (this.selectRangeIsDone) {
        ...
        console.log(this.rangeStartValue, this.rangeEndValue, this.isBigger(this.rangeStartValue, this.rangeEndValue)); // 比较大小
